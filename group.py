...
class User(object):
    ...
    # guess method allows each line of the haiku to be inputted
    def takeGuess(self, i):
        ...
        # TDB ADDED: 3 lines
        # for i in range(1,3):
        # I attempted to make this loop work but it wouldn't iterate each line - SM
...
def instructions():
    ...
    print("\nIf you can't remember what a Haiku is, it's a poem composed of three lines.")
    print("\nThe first line has 5 syllables, the second line has 10, followed by the third line of 5.")
...
# option to skip instructions
def skip():
    s = 0
    
    while s == 0:
        choose = input("Press 1 if you would like to skip the instructions, press 2 to proceed to the instructions.")
        if choose == "1":
            options()
        elif choose == "2":
            instructions()
        else:
            print("Sorry, please press 1 to skip, or 2 to proceed.")

# option to choose level of difficulty
# the timer() function is commented out because it waits the designated time
# and then shows the play() function
def options():
    b = 0
